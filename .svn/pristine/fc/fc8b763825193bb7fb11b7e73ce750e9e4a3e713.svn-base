                ...
                using (var db = new eSyaEnterprise())
                {
                    var sp = await db.GtEsopcl
                        ...
                        .Select(x => new DO_ClinicConsultationType
                        {
                            ...
                            ClinicTypeCode = db.GtEcapcd.Where(a => a.ApplicationCode == x.ClinicId).FirstOrDefault().ShortCode,
             ...
             int specialtyID, int doctorID, DateTime fromDate, DateTime toDate)
        {
            ...
            using (var db = new eSyaEnterprise())
            {
                while (fromDate <= toDate)
                {
                    ...
                    var isLeave = db.GtEsdold.Any(l => l.DoctorId == doctorID
                    ...
                    if (!isLeave)
                    {
                        ...
                        var l_ds = await db.GtEsdocd
                            .Join(db.GtEsdosc.Where(w => w.BusinessKey == businessKey
